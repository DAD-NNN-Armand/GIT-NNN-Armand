...
// console.log("BodyWidth =", document.body.getBoundingClientRect().width);
// console.log("BodyHeight =", document.body.getBoundingClientRect().height);
...
function BoutonDeCentrage() {
  ...
  const centerX =
    (bodyReference.width - card.getBoundingClientRect().width) / 2;
  const centerY =
    (bodyReference.height - card.getBoundingClientRect().height) / 2;
